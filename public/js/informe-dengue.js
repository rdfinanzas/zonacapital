(function(){
    ...
    async function fetchData(){
        ...
        const efector = document.getElementById('efector_sel') ? document.getElementById('efector_sel').value : 0;
        ...
        const res = await fetch(`/registros-dengue/informe?${params.toString()}`);
