                ...
                <div class="col-md-4">
                    <div class="card card-primary" id="card_form">
                        ...
                        <form role="form" id="form_main">
                            <input type="hidden" id="IdPedidoInterno" value="0">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="ServicioSolicitanteId">Servicio Solicitante:</label>
                                    <select class="form-control select2" id="ServicioSolicitanteId" required>
                                ...
                                <div class="form-group">
                                    <label for="ServicioDestinoId">Servicio Destino:</label>
                                    <select class="form-control select2" id="ServicioDestinoId" required>
                                        <option value="">-SELECCIONAR-</option>
                                        @foreach($servicios as $servicio)
                                            <option value="{{ $servicio->IdServicio }}">{{ $servicio->Servicio }}</option>
                                        @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="EstadoId">
                                        @foreach($estados as $estado)
                                            <option value="{{ $estado->IdPedidoInternoEstado }}">{{ $estado->PedidoInternoEstado }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <hr>
                                <h5>Bienes del Pedido</h5>
                                <div id="bienes_pedido_container">
                                    <div class="row bien-row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Detalle:</label>
                                                <input type="text" class="form-control bien-detalle">
                                            </div>
                                        </div>
                                ...
                                <form action="javascript:refrescarTabla()">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3">
                                                <label for="BuscarServicio">Servicio:</label>
                                                <select class="form-control" name="BuscarServicio" id="BuscarServicio">
...
@section('js')
    <script src="{{ asset('js/pedidos-internos.js') }}"></script>
@endsection
