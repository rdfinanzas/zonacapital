                ...
                <div class="col-md-4">
                    <div class="card card-primary" id="card_form">
                        ...
                        <form role="form" id="form_main">
                            <input type="hidden" id="IdOrdenPago" value="0">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="FechaEmicion">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="Estado_Id">
                                        @foreach($estados as $estado)
                                            <option value="{{ $estado->IdOrdenPagoEstado }}">{{ $estado->Estado }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="NumExp_Id">Expediente:</label>
                                    <select class="form-control" id="NumExp_Id">
                                        <option value="">-SELECCIONAR-</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control" id="Total" value="0" readonly>
                                </div>

                                <hr>
                                <h5>Bienes de la Orden de Pago</h5>
                                <button type="button" id="btn_agregar_bien" class="btn btn-sm btn-success mb-2">
                                ...
                                <hr>
                                <h5>Remitos</h5>
                                <button type="button" id="btn_agregar_remito" class="btn btn-sm btn-success mb-2">
                                    <i class="fas fa-plus"></i> Agregar Remito
                                </button>
                                <div id="remitos_container">
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Detalle de la Orden de Pago</h5>
...
@section('js')
    <script src="{{ asset('js/ordenes-pago.js') }}"></script>
@endsection
