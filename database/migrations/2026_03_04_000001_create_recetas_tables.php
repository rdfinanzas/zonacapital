...
class CreateRecetasTables extends Migration
{
    public function up()
    {
        ...
        Schema::create('recetas_programas', function (Blueprint $table) {
            $table->id();
        ...
        DB::table('recetas_programas')->insert([
        ...
        Schema::create('receta_entregas', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('receta_entregas');
        Schema::dropIfExists('receta_detalles');
        Schema::dropIfExists('recetas');
        Schema::dropIfExists('recetas_programas');
    }
}
